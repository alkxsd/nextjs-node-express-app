...
function CardExpenseSummary({}: Props) {
  ...
  const expenseSums = expenseCategoriesSummary.reduce((acc: ExpenseSums, item: ExpenseByCategorySummary) => {
        ...
        <>
          ...
          <div className='xl:flex justify-between pr-7'>
            ...
            <ul className='flex flex-col justify-around items-center xl:items-start py-5 gap-3'>
              {expenseCategories.map((entry, index) => (
                <li key={`legeng-${index}`} className='flex items-center text-xs'>
